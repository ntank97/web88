    ...
    <div class="container-fluid">
            ...
            <section class="content">
                ...
                <div class="box-header">
                    <a href="{{route('supports.add')}}" class="btn btn-primary">Thêm hỗ trợ</a>
                </div>
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-body">
                                <table id="example1" class="table table-bordered table-hover">
                                    ...
                                    @foreach($supports as $value)
                                        <tr class="odd gradeX" >
                                            ...
                                            <td >{{$value->email}}</td>
                                            <td>
                                                <a class="btn btn-default" href="{{Route('supports.edit',['id'=> $value->id]) }}" title="Edit"><i class="fas fa-pencil-ruler"></i> Sửa</a>
                                                <a href="{{Route('supports.delete',['id'=> $value->id]) }}" class="btn btn-danger" onclick="return confirmAction()">Xóa</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
