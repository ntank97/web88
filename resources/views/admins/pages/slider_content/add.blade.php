            ...
            <div class="row">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="{{route('slidercontent.index')}}"><i class="fa fa-file-text-o"></i> Danh
                                        sách<span class="label label-primary pull-right">{{$slidercontent_count}}</span></a></li>
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        ...
                        <form role="form" method="POST" action="{{route('slidercontent.store')}}"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nhập tên slidercontent" name="name"
                                           value="{{ old('name') }}">
                                </div>
