...
<div class="content">
    <div class="content__top">
        <div class="content__top-img" style=" background-image:url({{ asset('assets/img_service/'.$servis->image) }})">
            <div class="col-12 col-md-12 content-block">
                ...
                <div class="input-group form__search">
                    <p class="ghichu">{{ $servis->description }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-main">
        <div class="container">
            <div class="time">
                <span><i class="far fa-calendar-alt"></i>{{ $servis->created_at }}</span>
